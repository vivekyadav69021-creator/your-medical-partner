    ...
    <div className="flex flex-col items-center justify-center h-screen w-full overflow-hidden bg-gradient-to-br from-[#E6F0FF] via-[#FDFBFF] to-[#FFE9F0] dark:from-[#0f172a] dark:via-[#020617] dark:to-[#1e1b4b]">
      <div className="relative flex flex-col items-center justify-center text-center">
        ...
        <div className="relative flex flex-col items-center">
          <div className="font-headline flex flex-wrap items-center justify-center gap-x-2 text-4xl md:text-6xl font-black tracking-tight uppercase relative pb-10">
            <span 
            ...
            {/* Heartbeat (EKG) Line Animation - Centered and larger for visibility */}
            <div className="absolute -bottom-4 left-0 w-full px-2 opacity-0 animate-in fade-in duration-1000 fill-mode-forwards" style={{ animationDelay: '800ms' }}>
              <div className="w-full overflow-hidden h-12">
                  <svg 
                    ...
                    className="w-full drop-shadow-[0_0_10px_rgba(36,136,232,0.4)]"

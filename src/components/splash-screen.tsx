  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-full overflow-hidden bg-gradient-to-br from-[#E6F0FF] via-[#FDFBFF] to-[#FFE9F0] dark:from-[#0f172a] dark:via-[#020617] dark:to-[#1e1b4b]">
      <div className="relative flex flex-col items-center justify-center text-center">
        ...
        {/* Modern Medical Logo with Glow - Removed the white card */}
        <div className="relative mb-12 group">
          ...
          <div className="relative z-10 p-6 flex items-center justify-center animate-splash-pop-in">
            <div className="relative">
              <HeartPulse className="h-20 w-20 md:h-24 md:w-24 text-[#2488E8] drop-shadow-[0_0_15px_rgba(36,136,232,0.5)] animate-pulse" />
              
              {/* Integrated Medical Plus Symbol - Clean and Professional */}
        ...
        <div className="relative flex flex-col items-center">
          <div className="font-headline flex flex-wrap items-center justify-center gap-x-3 text-4xl md:text-6xl font-black tracking-tight uppercase">
            <span 
          ...
          {/* Continuous Heartbeat Line - Aligned exactly from the start of "Your" */}
          <div className="w-full mt-8 px-2 opacity-0 animate-in fade-in duration-1000 fill-mode-forwards" style={{ animationDelay: '1000ms' }}>
            <div className="max-w-[400px] mx-auto overflow-hidden">
                ...
                className="w-full drop-shadow-[0_0_12px_rgba(36,136,232,0.6)]"

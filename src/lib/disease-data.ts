...
export const diseases: Disease[] = [
  ...
  },
  {
    ...
    treatmentHi: `अपनी जीवनशैली बदलने سے उच्च रक्तचाप को नियंत्रित करने में काफी मदद मिल सकती है। आपका डॉक्टर जीवनशैली में बदलाव की सिफारिश कर सकता है जिसमें शामिल हैं:
    <ul>
  ...
  },
  {
    ...
    symptomsHi: '<ul><li>सांस लेने में तकलीफ</li><li>सीने में जकड़न या दर्द</li><li>सांस छोड़ते समय घरघराहट, जो बच्चों में अस्थमा کا एक आम संकेत है</li><li>सांस की तकलीफ, खांसी या घरघराहट के कारण सोने में परेशानी</li><li>खांसी या घरघराहट के दौरे जो श्वसन वायरस, जैसे सर्दी या फ्लू से बिगड़ जाते हैं</li></ul>',
    ...
    treatmentHi: 'उपचार में आमतौर पर अपने ट्रिगर्स को पहचानना, उनसे बचने के लिए कदम उठाना और यह सुनिश्चित करने के لیے अपनी सांसों पर नज़र रखना शामिल है कि आपकी दैनिक अस्थमा की दवाएं लक्षणों को नियंत्रित रख रही हैं। अस्थमा के बढ़ने की صورت میں، آپ کو فوری राहत देने वाले इन्हेलर का उपयोग करने की आवश्यकता हो सकती है।',
  ...
  },
  {
    ...
    treatmentHi: 'अवसाद वाले زیادہ تر لوگوں के लिए दवा और मनोचिकित्सा प्रभावी हैं। आपका प्राथमिक देखभाल चिकित्सक या एक मनोचिकित्सक लक्षणों से राहत के लिए दवाएं लिख सकता है। अवसाद वाले कई लोगों को मनोचिकित्सक, मनोवैज्ञानिक या अन्य मानसिक स्वास्थ्य पेशेवर से मिलने से भी फायदा होता है।',
    ...
    whenToSeeDoctorHi: 'यदि आप उदास महसूस करते हैं, तो जितनी جلدی हो सके अपने डॉक्टर या मानसिक स्वास्थ्य पेशेवर से मिलने के लिए अपॉइंटमेंट लें। यदि आप علاج کرانے में संकोच कर रहे हैं, तो किसी دوست या عزیز, किसी भी स्वास्थ्य देखभाल पेशेवर, किसी धर्मगुरु, या किसी اور پر بھروسہ کرنے वाले شخص से बात करें।',
  },
  {
    id: 'anxiety',
    ...
    treatmentHi: 'चिंता विकारों کے लिए दो मुख्य उपचार मनोचिकित्सा और दवाएं हैं। आपको दोनों के संयोजन से سب سے زیادہ فائدہ ہو سکتا ہے۔ यह पता लगाने में کچھ परीक्षण और त्रुटि लग सकती है कि आपके लिए कौन से उपचार سب سے اچھا کام کرتے ہیں۔',
  ...
  },
  {
    ...
    symptomsHi: '<ul><li>छींकना</li><li>नाक, आंखों या मुंह के ऊपरी हिस्से में खुजली</li><li>बहती, भरी हुई नाक</li><li>पानी वाली, लाल या सूजी ہوئی آنکھیں (नेत्रश्लेष्मलाशोथ)</li><li>मुंह में झुनझुनी</li><li>होंठ, जीभ, चेहरे या गले की सूजन</li><li>पित्ती</li></ul>',
  ...
  },
  {
    ...
    overviewHi: 'इन्फ्लूएंजा एक वायरल संक्रमण है जो आपके श्वसन तंत्र - आपकी नाक, गले और फेफड़ों पर हमला करता है। अधिकांश लोगों के लिए, फ्लू अपने आप ٹھیک ہو جاتا ہے۔ लेकिन कभी-कभी, इन्फ्लूएंजा और इसकी जटिलताएँ घातक हो सकती हैं।',
    ...
    symptomsHi: '<ul><li>बुखार</li><li>मांसपेशियों में दर्द</li><li>ठंड लगना और पसीना आना</li><li>सिरदर्द</li><li>सूखी, लगातार खांसी</li><li>सांस लेने में तकलीफ</li><li>थकान اور کمزوری</li><li>बहती या बंद नाक</li></ul>',
    ...
    treatmentHi: 'आमतौर पर, आपको फ्लू के इलाज के लिए आराम اور بہت सारे तरल पदार्थों से زیادہ कुछ नहीं चाहिए होगा। लेकिन अगर आपको गंभीर संक्रमण है या जटिलताओं का खतरा अधिक है, तो आपका डॉक्टर एक एंटीवायरल दवा लिख सकता है, जैसे कि oseltamivir (Tamiflu), zanamivir (Relenza), peramivir (Rapivab) या baloxavir (Xofluza)۔',
  ...
  },
  {
    ...
    overviewHi: 'निमोनिया एक संक्रमण है जो एक या दोनों फेफड़ों में वायु थैली को फुला देता है। वायु थैली द्रव या मवाद سے भर सकती है, जिससे बलगम या मवाद वाली खांसी, بخار, ठंड लगना, और सांस लेने में कठिनाई होती ہے۔',
    ...
    symptomsHi: '<ul><li>सांस लेने या खांसने पर سینے में درد</li><li>भ्रम या मानसिक जागरूकता में परिवर्तन (65 वर्ष और اس سے अधिक उम्र के वयस्कों में)</li><li>खांसी, जिससे बलगम پیدا हो सकता है</li><li>थकान</li><li>बुखार, पसीना और कंपकंपी वाली ठंड</li><li>मतली, उल्टी या दस्त</li><li>सांस लेने में तकलीफ</li></ul>',
    ...
    treatmentHi: 'निमोनिया के उपचार में انفیکشن کو ٹھیک کرنا और जटिलताओं को रोकना शामिल ہے۔ विशिष्ट उपचार आपके निमोनिया के प्रकार और गंभीरता, आपकी उम्र और आपके समग्र स्वास्थ्य पर निर्भर करते ہیں۔ विकल्पों में اینٹی بائیوٹکس, کھانسی की દવા, और بخار کم کرنے والی/درد निवारक शामिल ہیں۔',
    ...
    whenToSeeDoctorHi: 'यदि आपको सांस लेने में कठिनाई, سینے میں درد, 102 F (39 C) या उससे अधिक का लगातार بخار, या लगातार खांसी ہو, خاص طور پر اگر آپ کو کھانسی میں پیپ آ रही ہو تو अपने डॉक्टर से मिलें।',
  },
  {
    id: 'gastroenteritis',
    ...
    overviewHi: 'गैस्ट्रोएंटेराइटिस आंतों की परत की सूजन है जो वायरस, बैक्टीरिया या پرجیویوں کی वजह से होती ہے۔ इसे अक्सर "पेट का فلو" कहा जाता है, हालांकि यह इन्फ्लूएंजा वायरस की वजह سے नहीं होता ہے۔',
    ...
    whenToSeeDoctorHi: 'यदि आप 24 घंटे तक तरल पदार्थ नहीं पी पा रहे हैं, दो دن سے زیادہ समय से उल्टी कर रहे हैं, खून की उल्टी कर रहे हैं, निर्जलित हैं, अपने मल में खून देखते हैं, या 104 F (40 C) से ऊपर बुखार है, तो डॉक्टर से ملیں۔',
  },
  {
    id: 'copd',
    ...
    treatmentHi: 'सीओपीडी वाले कई लोगों को बीमारी के ہلکے रूप होते हैं, जिसके लिए धूम्रपान छोड़ने के अलावा बहुत कम चिकित्सा की आवश्यकता होती है। بیماری के زیادہ উন্নত مراحل کے لیے, प्रभावी चिकित्सा उपलब्ध है जो लक्षणों को नियंत्रित कर सकती है, प्रगति को धीमा कर सकती है, जटिलताओं और तीव्रता के जोखिम को कम कर सकती है, और एक सक्रिय जीवन जीने की आप की क्षमता में सुधार कर सकती ہے۔',
    ...
    whenToSeeDoctorHi: 'यदि आपके लक्षण उपचार से बेहतर नहीं हो रहे हैं या खराब हो रहे हैं, या यदि आप संक्रमण के کوئی लक्षण देखते हैं, जैसे कि बुखार या आपके थूक में परिवर्तन, तो अपने डॉक्टर से मिलें।',
  },
  {
    id: 'bronchitis',
    nameEn: 'Bronchitis',
    ...
    overviewHi: 'ब्रोंकाइटिस आपके ब्रोन्कियल ट्यूबों की परत की सूजन है, जो आपके फेफड़ों तक हवा ले जाती हैं और उनसे हवा ले जाती हैं। ब्रोंकाइटिस वाले लोग अक्सर گاڑھا بلغم کھانستے ہیں, જે رنگین हो सकता ہے۔ ब्रोंकाइटिस या तो तीव्र या دائمی ہو सकता ہے۔',
  ...
  },
  {
    ...
    symptomsHi: '<ul><li>पसलियों के नीचे, کنارے और پیٹھ में شدید, تیز درد</li><li>दर्द जो निचले पेट और कमर तक پھیلتا है</li><li>दर्द जो लहरों में आता है और तीव्रता में उतार-चढ़ाव करता है</li><li>पेशाब करते समय درد یا جلن</li><li>गुलाबी, लाल या भूरा मूत्र</li><li>बादलदार या दुर्गंधयुक्त मूत्र</li></ul>',
    ...
    treatmentHi: 'छोटे पत्थरों का इलाज पानी पीने और درد निवारक लेने जितना सरल हो सकता ہے۔ بڑے पत्थरों کے لیے, उपचार में उन्हें तोड़ने या हटाने के लिए طبی प्रक्रियाएं शामिल हो सकती हैं। इसमें एक्स्ट्राकॉर्पोरियल शॉक वेव लिथोट्रिप्सी (ESWL) या سرجری شامل ہے۔',
  ...
  },
  {
    ...
    treatmentHi: 'एनीमिया का इलाज وجہ پر منحصر ہے۔ यह सप्लीमेंट्स लेने से لے کر طبی प्रक्रियाएं کروانے तक ہو سکتا ہے۔ उपचार में آئرن की कमी वाले एनीमिया کے لیے آئرن سپلیمنٹس, وٹامن B-12 شاٹس, या خون چڑھانا شامل हो सकता ہے۔',
    ...
    whenToSeeDoctorHi: 'यदि आपको अस्पष्टीकृत थकान या एनीमिया के अन्य लक्षण हैं तो डॉक्टर से मिलें। कुछ एनीमिया, जैसे कि आयरन की कमी वाला एनीमिया या विटामिन बी-12 एनीमिया, आम हैं। लेकिन यह نہ مانیں کہ اگر आप تھکے ہوئے ہیں, तो آپ کو انیمیا होना चाहिए।',
  },
  {
    id: 'osteoporosis',
    nameEn: 'Osteoporosis',
    ...
    overviewHi: 'ऑस्टियोपोरोसिस हड्डियों को कमजोर और भंगुर बना देता है - इतना भंगुर कि गिरने या ہلکے तनाव जैसे कि جھکने या کھانسنے से भी فریکچر ہو سکتا ہے۔ ऑस्टियोपोरोसिस से संबंधित फ्रैक्चर सबसे आम तौर पर کولہے, کلائی या ریڑھ की हड्डी में होते ہیں۔',
    ...
    symptomsHi: 'हड्डियों के नुकसान के शुरुआती चरणों में आमतौर पर कोई लक्षण नहीं होते हैं। लेकिन एक बार जब आपकी हड्डियां ऑस्टियोपोरोसिस سے कमजोर हो जाती हैं, तो आप के पास ऐसे संकेत और लक्षण हो सकते हैं जिनमें शामिल हैं: کمر درد, जो टूटी हुई या ढह गई कशेरुका के कारण होता है, समय के साथ قد में कमी, झुकी हुई मुद्रा, एक हड्डी जो अपेक्षा से کہیں زیادہ آسانی سے टूट جاتی ہے۔',
  ...
  },
  {
    ...
    treatmentHi: 'गर्ड के उपचार में जीवनशैली में बदलाव, दवाएं, या सर्जरी शामिल हो सकती है। जीवनशैली में बदलाव जैसे कि अतिरिक्त वजन کم کرنا, छोटे भोजन करना, और उन खाद्य पदार्थों से बचना जो नाराज़गी को متحرک کرتے ہیں, मदद कर सकते हैं। दवाओं में एंटासिड, H2 ब्लॉकर्स, और प्रोटॉन पंप अवरोधक शामिल हैं।',
  ...
  },
  {
    ...
    symptomsHi: '<ul><li>पेट दर्द, ऐंठन या सूजन जो मल त्याग से संबंधित ہے</li><li>मल की ظاہری شکل में परिवर्तन</li><li>आप कितनी बार मल त्याग कर रहे हैं इस में परिवर्तन</li><li>मल में सूजन, गैस में वृद्धि या बलगम</li></ul>',
  ...
  },
  {
    ...
    overviewHi: 'मलेरिया एक परजीवी के कारण होने वाली بیماری ہے۔ यह परजीवी संक्रमित मच्छरों के کاٹنے से मनुष्यों में फैलता ہے۔ मलेरिया से पीड़ित लोग आमतौर पर तेज بخار और कंपकंपी के साथ बहुत بیمار महसूस करते ہیں۔',
    ...
    whenToSeeDoctorHi: 'यदि आप किसी उच्च जोखिम वाले मलेरिया क्षेत्र में रहते ہوئے या यात्रा करने के बाद بخار کا تجربہ کرتے ہیں तो अपने डॉक्टर से बात करें। यदि आपके लक्षण गंभीर हैं, तो आपातकालीन चिकित्सा सहायता लें।',
  },
  {
    id: 'tuberculosis',
    ...
    overviewHi: 'तपेदिक (टीबी) एक गंभीर संक्रामक रोग है जो मुख्य طور پر फेफड़ों को متاثر کرتا ہے۔ तपेदिक का कारण बनने वाले बैक्टीरिया ایک व्यक्ति से दूसरे व्यक्ति में کھانسی और छींकों के ذریعے हवा में छोड़ी گئی چھوٹی بوندوں से फैलते ہیں۔',
...
symptomsHi: '<ul><li>तीन या उससे अधिक सप्ताह तक खांसी रहना</li><li>खून या بلغم वाली खांसी</li><li>सीने में दर्द, या सांस लेने या کھانسنے کے साथ درد</li><li>अनजाने में वजन कम होना</li><li>थकान</li><li>बुखार</li><li>रात को पसीना आना</li><li>कंपकंपी</li></ul>',
    ...
    treatmentHi: 'दवाएं तपेदिक के उपचार का आधार हैं। लेकिन टीबी का علاج अन्य प्रकार के जीवाणु संक्रमणों के علاج से कहीं زیادہ समय लेता ہے۔ आपको कम से कम چھ से नौ महीने तक एंटीबायोटिक्स लेनी चाहिए।',
    ...
    whenToSeeDoctorHi:"यदि आपको बुखार, अस्पष्टीकृत वजन घटाने, रात को पसीना आने या लगातार खांसी हो तो ਆਪਣੇ डॉक्टर से मिलें। ये अक्सर टीबी के संकेत होते हैं लेकिन अन्य चिकित्सा समस्याओं के परिणामस्वरूप भी ہو सकते हैं।",
  },
  {
    id: 'dengue',
    nameEn: 'Dengue Fever',
    ...
    overviewHi: 'डेंगू बुखार एक मच्छर जनित बीमारी है जो दुनिया के उष्णकटिबंधीय और उपोष्णकटिबंधीय क्षेत्रों में होती ہے۔ ہلکے डेंगू बुखार में तेज بخार और फ्लू جیسے लक्षण होते हैं। डेंगू बुखार का गंभीर रूप, जिसे डेंगू रक्तस्रावी بخار भी कहा جاتا ہے, गंभीर रक्तस्राव, रक्तचाप में अचानक गिरावट (सदमे) और मृत्यु का कारण बन सकता ہے۔',
  ...
  },
  {
    ...
    overviewHi: 'टाइफाइड बुखार एक जीवाणु संक्रमण है जो तेज بخार, दस्त, और उल्टी का कारण बन सकता ہے۔ यह घातक हो सकता ਹੈ। यह साल्मोनेला टाइफी बैक्टीरिया के कारण होता ਹੈ। संक्रमण अक्सर दूषित भोजन और پینے के पानी के ذریعے फैलता ہے۔',
    ...
    whenToSeeDoctorHi: 'यदि आपको संदेह है कि आपको टाइफाइड بخार है तो तुरंत डॉक्टर से मिलें। यदि आप کسی विदेशी देश में यात्रा कर रहे हैं, तो आप आमतौर पर डॉक्टरों की فہرست کے لیے अपने दूतावास के कांसुलर सेक्शन को کال کر सकते हैं।',
  },
  {
    id: 'jaundice',
    nameEn: 'Jaundice',
    ...
    treatmentHi: 'पीलिया का उपचार पीलिया के बजाय कारण को लक्षित करता है। उपचार में वायरल हेपेटाइटिस के लिए सहायक देखभाल, रुकावट के लिए سرجری, या पीलिया पैदा करने वाली दवा को रोकना شامل हो सकता ہے۔',
  ...
  },
  {
    ...
    overviewHi: 'स्कर्वी विटामिन सी (एस्कॉर्बिक एसिड) की कमी से होने वाली बीमारी है। कमी के शुरुआती लक्षणों में कमजोरी, थका हुआ محسوس करना, और हाथ-पैर में दर्द شامل ہیں۔ इलाज के बिना, लाल रक्त कोशिकाओं में कमी, मसूड़ों की बीमारी, बालों में बदलाव, और त्वचा से खून बहना ہو सकता ہے۔',
    ...
    symptomsHi: '<ul><li>थकान और कमजोरी</li><li>मसूड़ों की बीमारी (मसूड़े की सूजन)</li><li>آسانی سے चोट लगना और खून بہنا</li><li>जोड़ों का दर्द</li><li>घाव का खराब भरना</li><li>अवसाद</li></ul>',
    ...
    treatmentHi: 'स्कर्वी का इलाज विटामिन सी سپلیمنٹس लेने और وٹامن सी से بھرپૂર आहार खाने से کیا جاتا ہے۔ कई लक्षण कुछ दिनों से लेकर कुछ ہفتوں میں بہتر ہو जाते ہیں۔',
...
symptomsHi: '<ul><li>बुखार</li><li>सिरदर्द</li><li>मतली और الटी</li><li>आंदोलन, चिंता, भ्रम</li><li>अति सक्रियता, निगलने में कठिनाई</li><li>अत्यधिक लार</li><li>निगलने में कठिनाई के कारण पानी से ڈر (हाइड्रोफोबिया)</li></ul>',
    ...
    treatmentHi: 'एक बार रेबीज संक्रमण स्थापित हो जाने पर, कोई प्रभावी उपचार नहीं है। हालांकि कुछ लोगों ने रेबीज से جان بچائی ہے, यह بیماری आमतौर पर मौत کا سبب بنتی ہے۔ इस कारण से, यदि आपको लगता है कि आप रेबीज के संपर्क में आए हैं, तो आपको संक्रमण को पकड़ने से रोकने के लिए शॉट्स की एक श्रृंखला लेनी चाहिए।',
